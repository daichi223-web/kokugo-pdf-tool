...
export interface ImageEnhancement {
  ...
  textDarkness: number; // 文字の濃さ 0.3〜1.5（1.0がデフォルト、小さいほど濃い）ガンマ補正
  ...
  sigmoidContrast: boolean; // シグモイドコントラスト（S字カーブで文字と背景を強力に分離）
  textBolden: boolean; // 文字太らせ（モルフォロジー膨張、十字型カーネル1回）
}
